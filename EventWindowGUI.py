...
class EventWindow():
    ...
    def checkbox_section(self):
        ...
        label_satelites.grid(column=1, row=0, pady= 10)
        ...
        checkbutton_incidence.grid(column=2, row=4, padx=0)
        ...
        label_attention_inc.grid(column=2, row=5, padx=30)
